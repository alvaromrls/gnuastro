...
**********************************************************************/
#ifndef __GAL__COMPLEX_ARRAY__
#define __GAL__COMPLEX_ARRAY__
...
void gal_complex_array_to_real (gsl_complex_packed_array complexarray,
                                size_t size, complex_to_real action,
                                double **output);

void gal_complex_array_multiply (gsl_complex_packed_array first,
...
void gal_complex_array_create_padding (const gal_data_t *image,
                                       const gal_data_t *kernel,
                                       gsl_complex_packed_array *outputimage,
                                       gsl_complex_packed_array *outputkernel,
                                       size_t *xdim, size_t *ydim);

void gal_complex_array_normalize (gsl_complex_packed_array inout, size_t size);

double gal_complex_array_module (gsl_complex_packed_array input, size_t size);
