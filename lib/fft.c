 ...
 *
 * @param params Output array with all the needed params for a FFT.
 * @param numthreads Number of threads.
 * @param dim 2D dimension size (X,Y).
 * @param input Data input.
 * @param output Data output.
 * @param sign Direct or Reverse FFT.
 */
void
 ...
 *
 * @param params Created by gal_fft_init.
 * @param numthreads Number of threads.
 */
void
 ...
 *
 * @param p Void pointer to be converted to a fft_params* array.
 */
void *
 ...
 * (implace).
 * *
 * @param kernel The kernel to be shifted.
 * @param dim 2D dimension size (X,Y).
 */
void
